...
export function Connect(){var x = 1;}
...
const contractABI = [[
	...
	},
	{
		...
		"name": "RewardManagerUnauthorized",
		"type": "event"
	},
	{
		"anonymous": false,
...
export async function authorizeRewardManager(tokenAddress, managerAddress) {
    try {
        console.log(tokenAddress);
        console.log(tokenAddress);
      const accounts = await web3.eth.getAccounts();
      const result = await contract .methods
        .authorizeRewardManager(tokenAddress, managerAddress)
